...
export const UserCard = ({ username }) => {
  ...
  return (
    <Card shadow="none" className="max-w-[300px] border-none bg-transparent -mx-2">
      <CardHeader className="justify-between ">
        <div className="flex gap-3">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <Link href={userData.blog.startsWith("http") ? userData.blog : `https://${userData.blog}`} target="_blank" aria-label={userData.blog}>
              <h5 className="text-small tracking-tight text-default-500 dark:text-gray-400">{userData.blog || ''}</h5>
            </Link>
          </div>
        </div>
      ...
      <CardFooter className="gap-3 text-default-foreground dark:text-default-50 justify-between">
