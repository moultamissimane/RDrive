...
export function X() {
        return (
          <svg xmlns="http://www.w3.org/2000/svg" className="fill-current text-black/70 dark:text-white/70 hover:text-black hover:dark:text-white h-6 w-6" viewBox="0 0 24 24" version="1.1">
