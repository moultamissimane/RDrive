...
import { BsFiletypeExe, BsFiletypeGif, BsFiletypeHeic, BsMarkdownFill } from 'react-icons/bs';
import { FaFileImage, FaFilePdf, FaFileWord, FaFilePowerpoint, FaFileExcel, FaFileAudio, FaFileVideo, FaFileArchive, FaFileCode, FaFileAlt, FaFile, FaBook, FaLink, FaWindows } from 'react-icons/fa';
